 ...
 * @author bertocco
 */
public class VOSpaceBackendReadInputException extends VOSpaceBackendException {
 
     VOSpaceBackendReadInputException ( String str ) {
	super(str);
    } 
     

    public VOSpaceBackendReadInputException(Throwable cause) {
        super(cause);
    }

    public VOSpaceBackendReadInputException(String message, Throwable cause) {
        super(message, cause);        
    }
